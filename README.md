...
以下截图来自 2026-07-17 本地运行的前端页面，后端连接团队共享 MySQL，页面左下角 `LIVE API` 表示数据来自真实接口。截图只展示演示账号和业务数据，不包含 API Key、数据库密码或令牌。

#### 登录与角色入口

<img src="docs/images/demo-login.jpg" alt="ContextGuard 登录页，展示普通用户和审核员演示账号" width="360">

#### 用户端社区首页

<img src="docs/images/demo-community.jpg" alt="用户端社区首页，展示话题、楼层统计和发布审核闭环" width="820">

#### 话题楼层与发布前审核

<img src="docs/images/demo-topic-detail.jpg" alt="话题详情页，展示线性楼层、申诉通过状态和发布前审核输入区" width="820">

#### 审核数据统计看板

<img src="docs/images/demo-statistics.jpg" alt="审核员端统计看板，展示内容总量、申诉通过率、人工改判率和风险分布" width="820">

#### 审核规则配置

<img src="docs/images/demo-rules.jpg" alt="审核规则配置页，展示规则版本、阈值、证据开关和分歧转人工策略" width="820">
