...
def get_statistics(
    ...
    return {
        ...
        "runtime": {
            ...
            "primaryModel": provider.model_version,
            "secondaryProvider": secondary_provider.name if secondary_provider else None,
            "secondaryModel": secondary_provider.model_version if secondary_provider else None,
